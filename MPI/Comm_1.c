...
MPI_Init(&argc,&argv);
 ...
 int my_id;
 int dim = 2;
 /* To generalize, you can also use MPI_Dims_Create(nprocs,dim,dims)
  * to replace the creation of dims array (below) by hand. 
  * This routine minimizes the diameter of the created topology. */
