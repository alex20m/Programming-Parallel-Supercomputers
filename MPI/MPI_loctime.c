...
int main(int argc, char** argv) {
  ...
  /* Example of usage of commands to time MPI communication pattern */
  ...
  /* On Sheet1 you should think of a way of timing the completetion of a matching send and receive */
  if (my_id == 0) {
  start=MPI_Wtime();
