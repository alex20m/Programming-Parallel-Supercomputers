...
Hence, for obtaining reliable mean values, you have to repeat the measurement at an appropriate rate. You should also repeat the measurement several times in your code and ignore the first few results to exclude effects of initializing the communication.
